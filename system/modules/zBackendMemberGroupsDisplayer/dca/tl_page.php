...
$GLOBALS['TL_DCA']['tl_page']['list']['label']['label_callback'] = array('tl_page_BackendMemberGroupsDisplayer', 'setLabel');

/**
 * Class tl_page_BackendMemberGroupsDisplayer
 *
 ...
 * @package    Controller
 */
class tl_page_BackendMemberGroupsDisplayer extends tl_page
{
	/**
	 * Set the new label
	 * @param array
