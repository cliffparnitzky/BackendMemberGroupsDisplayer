...
$GLOBALS['TL_DCA']['tl_article']['list']['label']['label_callback'] = array('tl_article_BackendMemberGroupsDisplayer', 'setLabel');

/**
 * Class tl_article_BackendMemberGroupsDisplayer
 *
 ...
 * @package    Controller
 */
class tl_article_BackendMemberGroupsDisplayer extends tl_article
{
	/**
	 * Set the new label
	 * @param array
