...
$GLOBALS['TL_DCA']['tl_calendar']['list']['label']['label_callback'] = array('tl_calendar_BackendMemberGroupsDisplayer', 'setLabel');

/**
 * Class tl_calendar_BackendMemberGroupsDisplayer
 *
 ...
 * @package    Controller
 */
class tl_calendar_BackendMemberGroupsDisplayer extends tl_calendar
{
	/**
	 * Set the new label
	 * @param array
